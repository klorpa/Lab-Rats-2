...
label mom_outfit_help_crisis_label():
            ...
            "Try and peek.":
                ...
                while strip_choice is not None and not caught:
                    ...
                    if renpy.random.randint(0,100) < 10: #you got caught
                        ...
                        $ the_person.change_slut(1+the_person.get_opinion_score("not wearing anything"), 30)
    ...
    menu:
        ...
        "Say it's not revealing enough.":
            ...
            $ the_person.change_slut(1+the_person.get_opinion_score("skimpy uniforms"), 20)
            ...
            "Try and peek.":
                ...
                while strip_choice is not None and not caught:
                    ...
                    if renpy.random.randint(0,100) < 10: #you got caught
                        ...
                        $ the_person.draw_person(emotion = "angry")
                        $ the_person.change_happiness(-5)
                        $ the_person.change_slut(1+the_person.get_opinion_score("not wearing anything"))
                        the_person "[the_person.mc_title], are you watching me change!"
                        mc.name "No, I... The mirror was just sort of there."
                        "She covers herself with her hands and motions for the door."
                        the_person "Could you wait outside, please?"
                            ...
                            if the_choice == "Order her to open her mouth.":
                                ...
                                if the_person.outfit.tits_visible():
                                    ...
                                    if the_person.outfit.can_half_off_to_tits():
                                        ...
                                        $ generalised_strip_description(the_person, strip_list, half_off_instead = True, position = "blowjob")
                                    else:
                                        $ strip_list = the_person.outfit.get_tit_strip_list()
                                        $ generalised_strip_description(the_person, strip_list, position = "blowjob")
                                    $ mc.change_locked_clarity(10)
        ...
        menu:
            ...
            "Knock on the door.":
                ...
                if the_person.effective_sluttiness(["bare_tits","bare_pussy"]) > 30:
                    ...
                    call girl_shower_enter(the_person, surprised = False) from _call_girl_shower_enter
                else:
            ...
            "Barge in anyways.":
                ...
                if the_person.effective_sluttiness(["bare_tits", "bare_pussy"]) < 10:
                    ...
                    $ clear_scene()
                    $ the_person.change_love(-1)
                    $ the_person.change_slut(1 + the_person.get_opinion_score("not wearing anything"), 20)
                    $ the_person.get_opinion_score("not wearing anything")
                    call girl_shower_leave(the_person) from _call_girl_shower_leave_2
                else:
                    call girl_shower_enter(the_person, surprised = True) from _call_girl_shower_enter_1 #TODO: Decide if we need different dialogue for this (maybe just a "surprised" tag we can pass)
    ...
    menu:
        "Wait and watch her shower.":
            ...
            if the_person.effective_sluttiness() > 40 - (5 * (the_person.get_opinion_score("showing her tits")+the_person.get_opinion_score("showing her ass"))):
                ...
                $ the_person.change_slut(1+(the_person.get_opinion_score("showing her tits")+the_person.get_opinion_score("showing her ass")), 50)
            else:
        ...
        "Join her in the shower." if the_person.obedience >= 120:
            ...
            if the_person.effective_sluttiness("touching_body") <= 40:
                ...
                $ mc.change_locked_clarity(10)
                $ the_person.change_slut(2 + the_person.get_opinion_score("showing her ass"), 40)
                "She steps out of the shower and grabs a towel."
                $ the_person.apply_outfit(towel_outfit)

            # elif the_person.effective_sluttiness() <= 60: #TODO: Add a "thigh fuck" position and use it here
            #     "She wiggles her butt and strokes your tip against her cheeks."
            #     the_person "Do you need some help with this? How about you just... use my thighs?"
...
label cousin_tease_crisis_label():
    ...
    if the_person.effective_sluttiness("underwear_nudity") < 35: #She'll want money
        ...
        menu:
            "Send [the_person.title] some money.\n-$100" if mc.business.has_funds(100):
            ...
            "Send [the_person.title] some money.\n-$100 (disabled)" if mc.business.has_funds(100):
                pass
            ...
            "Ask why she needs it.":
                ...
                if the_person.outfit.tits_visible():
                    ...
                    menu:
                        ...
                        "Send [the_person.title] some money.\n-$100 (disabled)" if not mc.business.has_funds(100):
                            pass
