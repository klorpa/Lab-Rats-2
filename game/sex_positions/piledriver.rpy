            ...
            "Talk dirty to her.":
                ...
                if the_girl.sex_skills["Foreplay"] > 2: #She's good at foreplay, flirting, etc.
                    ...
                    if the_girl.get_opinion_score("creampies") > 0 or the_girl.get_opinion_score("bareback sex") > 0:
                        the_girl "Oh... I want to watch you cum [the_girl.mc_title]. I want to watch you unload deep inside of me. I want to feel your hot cum dripping out of me..."
...
label scene_piledriver_2(the_girl, the_location, the_object):
    ...
    if the_girl.sex_skills["Vaginal"] < 3:
        the_girl "Ah... Take it easy, I'm not... use to doing this."
    else:
        ...
        "Fondle her tits.":
            if the_girl.has_large_tits():
                if the_girl.outfit.tits_available():
                    ...
                    the_girl "Be gentle with them, they're sensative."
...
label outro_piledriver(the_girl, the_location, the_object):
    ...
    if the_choice == "Cum inside of her.":
        ...
        $ piledriver.redraw_scene(the_girl)
        if the_girl.sluttiness > 80 or the_person.get_opinion_score("drinking cum") > 0:
            $ the_girl.discover_opinion("drinking cum")
