init:
    python:
        cunnilingus = Position(name = "Cunnilingus", slut_requirement = 40, slut_cap = 60, requires_hard = False, requires_large_tits = False,
            position_tag = "sitting", requires_location = "Sit", requires_clothing = "Vagina", skill_tag = "Oral",
...
label intro_cunnilingus(the_girl, the_location, the_object, the_round):
...
label scene_cunnilingus_1(the_girl, the_location, the_object, the_round):
...
label scene_cunnilingus_2(the_girl, the_location, the_object, the_round):
...
label outro_cunnilingus(the_girl, the_location, the_object, the_round): #With low arousal gain this is unlikely to come up much
...
label transition_default_cunnilingus(the_girl, the_location, the_object, the_round):
...
label strip_cunnilingus(the_girl, the_clothing, the_location, the_object, the_round):
...
label strip_ask_cunnilingus(the_girl, the_clothing, the_location, the_object, the_round):
...
label orgasm_cunnilingus(the_girl, the_location, the_object, the_round):
