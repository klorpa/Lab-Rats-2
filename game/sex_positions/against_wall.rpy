        ...
        "Kiss her.":
            ...
            if the_girl.sex_skills["Foreplay"] > 2: #Experienced kisser
                if the_girl.get_opinion_score("kissing") > 0:
                    ...
                    the_girl "[the_girl.possessive_title] shivers with pleasure when your tongues meet. She bucks her hips against yours, suddenly desperate to have you deeper inside of her."
                else:
                    the_girl "[the_girl.possessive_title] returns your kiss, darting her tongue out to meet yours."
                    if the_girl.outfit.tits_available():
    ...
    menu:
        "Grab her ass.":
            ...
            if the_girl.sex_skills["Vaginal"] < 3:
                the_girl "Oh my god, yes! Keep that cock deep inside of me!"
