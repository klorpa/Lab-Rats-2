...
label ask_leave_SO_label(the_person): #
    ...
    the_person.char "You know I've always got five minutes for you."
...
label plan_fuck_date_label(the_person):
    ...
    menu:
        ...
        "Maybe some other time.":
            ...
            the_person.char "Oh well, your loss."
...
label fuck_date_label(the_person):
    ...
    menu:
        ...
        "Cancel the date. (tooltip)She won't be happy with you canceling last minute.":
            ...
            the_person.char "And I just finished getting all dressed up for you. Oh well."
            return
    ...
    if the_person.obedience > 130 or the_person.get_opinion_score("being submissive") > 0 or the_person.get_opinion_score("giving blowjobs") > 0:
        ...
        the_person.char "Hello [the_person.mc_title]... I've been thinking about this all day."
    ...
    while done == False:
        ...
        if mc.current_stamina == 0: #Forced to end the fuck date, so we set done to True.
            ...
            if girl_came:
                ...
                the_person.char "Now you should get going before my [so_title] gets home."
            ...
            menu:
                "Fuck her again.":
                    ...
                    if random_num < 3 and not so_called:
                        ...
                        mc.name "Is that..."
                        the_person.char "My [so_title]. Oh my god, what are we going to do?"
                        ...
                        menu:
                            "Hide!":
                                ...
                                the_person.char "Maybe a little, I didn't think you were going to be home tonight."
                                ...
                                the_person.char "Of course, sweetheart."
                            ...
                            "Fuck her anyways!" if the_person.love + the_person.effective_sluttiness() >= leave_SO_love_calculation + 60:
                                ...
                                the_person.char "He's right, you don't need to be here to see this. I'm sorry!"
                        ...
                        the_person.char "That's my phone, I'm so sorry. One second."
                        $ the_person.draw_person(position = "doggy")
                        "She crawls over the bed and looks at her phone."
                        the_person.char "Fuck, it's my [so_title]. Just be quiet, okay?"
                        ...
                        menu:
                            ...
                            "Grope her.":
                                ...
                                the_person.char "Oh god, you're so bad!"
                ...
                "Call it a night.":
                    ...
                    if girl_came:
                        ...
                        the_person.char "Really? I didn't even get to cum yet..."
                        $ the_person.change_love(-1)
                        $ the_person.change_slut_temp(-1)
                    $ done = True
...
label caught_affair_cheating_label(the_other_girl, the_girlfriend):
    ...
    if the_girlfriend.love < 60:
        ...
        the_girlfriend.char "I guess, but I thought we had something special. Could you at least cut back a little with other women?"
