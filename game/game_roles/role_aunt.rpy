...
label aunt_intro_phase_two_label():
    ...
    python:
        ...
        aunt.set_schedule(aunt.home, the_times = [0,1,2,3,4]) #Hide them in their bedroom off the map until they're ready.
...
label aunt_intro_moving_apartment_label(the_person):
    ...
    if aunt.event_triggers_dict.get("moving_apartment") == 0:
        ...
        menu:
            "Pay for the pizza.\n-$25" if mc.business.has_funds(25):
            ...
            "Pay for the pizza.\n-$25 (disabled)" if mc.business.change_funds(25):
                pass
...
label aunt_intro_phase_final_label():
    ...
    python:
        ...
        aunt.set_schedule(aunt.home, the_times = [0,4])
        aunt.set_schedule(aunt_apartment, the_times = [1,2,3])
        cousin.set_schedule(cousin.home, the_times = [0,4])
