...
label reserved_strip_reject(the_person, the_clothing, strip_type = "Full"):
    if the_person.obedience > 130:
        the_person.char "I'm sorry [the_person.mc_title], but I think my [the_clothing.display_name] should stay where it is for now. For modesty's sake."
...
label reserved_strip_obedience_accept(the_person, the_clothing, strip_type = "Full"):
    ...
    if the_person.obedience > 130:
        the_person.char "I... I'm sorry, but I don't know if you should take that off [the_person.mc_title]..."
    else:
...
label reserved_flirt_response_low(the_person):
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            ...
            the_person.char "Well, thank you. I appreciate the complement."
        else:
            #She's in uniform, but she thinks it's a little too slutty.
            if the_person.outfit.vagina_visible():
                # Her pussy is on display.
                the_person.char "It's not much of an outfit at all though."
                the_person.char "I understand it's the company uniform, but it would be nice to have a little more coverage."
                ...
                if the_person.has_large_tits():
                    the_person.char "Thank you, but I can tell this uniform was designed by a man."
                    the_person.char "Larger chested women, like myself, appreciate a little more support in their outfits."
                else:
                    the_person.char "Thank you, but I do hope you'll consider a uniform with a proper top in the future."
                    the_person.char "It still doesn't feel natural having my... breasts so visible."
                mc.name "I understand it's a little uncomfortable, but I'm sure you'll get use to it."
                the_person.char "Yes, given enough time I'm sure I will."
                ...
                the_person.char "I'll think about it."
...
label reserved_flirt_response_mid(the_person):
    if the_person.outfit == the_person.planned_uniform:
        if the_person.judge_outfit(the_person.outfit):
            ...
            the_person.char "I don't mind it so much if it's just me and you, but when there are other people around I wish it kept me a little more covered."
...
label reserved_flirt_response_high(the_person):
    if mc.location.get_person_count() > 1 and the_person.effective_sluttiness() < (25 - (5*the_person.get_opinion_score("public_sex"))): # There are other people here, if she's not slutty she asks if you want to find somewhere quiet
        ...
        if mc.location.get_person_count() == 1: #She's shy but you're alone
            ...
            the_person.char "Okay. You're right. What... do you want to do then?"

        else:  #You're not alone, but she doesn't care.
            the_person.char "Well I wouldn't want you to go crazy. You'll just have to do something to get me out of this outfit then..."
...
label reserved_flirt_response_girlfriend(the_person):
    ...
    if mc.location.get_person_count() > 1:
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            the_person.char "Oh, well thank you [the_person.mc_title]. You're so sweet."
            "She leans in and gives you a quick peck on the cheek."
            the_person.char "I wish we had a little more privacy. Oh well, maybe later."
            menu:
                "Find someplace quiet.":
                ...
                "Just flirt.":
                    ...
                    the_person.char "I'll make sure to make it worth the wait, but let's take it easy while other people are around."
            ...
            the_person.char "Was that nice? You're very nice to kiss."
            menu:
                "Make out.":
                ...
                "Just flirt.":
                    ...
                    if the_person.effective_sluttiness("sucking_cock") >= 60 or the_person.get_opinion_score("giving blowjobs") > 0:
                        ...
                        the_person.char "Mmmm, stop it [the_person.mc_title]. You're going to get me all wet in public."
                        ...
                        the_person.char "Oh my god, [the_person.mc_title]! Save it for later though, I like what you're thinking..."
    else:
        # You're alone, so she's open to fooling around.
        "She smiles happily."
        the_person.char "Oh, well thank you [the_person.mc_title]. I'm lucky to have you too."
...
label reserved_flirt_response_affair(the_person):
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.get_opinion_score("cheating on men") *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            the_person.char "Oh [the_person.mc_title], stop. If you keep talking like that you're going to get me turned on."
            mc.name "And what would be so bad about that?"
            the_person.char "It would be so frustrating being in public and not being able to do anything to get my satisfaction."
            menu:
                "Find someplace quiet.":
            ...
            the_person.char "[the_person.mc_title], you can't talk like that when there are other people around."
            the_person.char "You don't want my [so_title] to hear any rumours, do you? If he gets suspicious you might not get to see me so much..."
            "She runs a hand discretely along your arm."
            the_person.char "That would be such a shame, wouldn't it?"
            mc.name "Alright, I'll be more careful."
            the_person.char "Thank you. Just hold onto all those naughty thoughts and we can check them off one by one when we're alone."
    else:
        the_person.char "Oh is that so [the_person.mc_title]? Well, maybe you need to work out some of those naughty instincts..."
        ...
        menu:
            ...
            "Just flirt.":
                ...
                the_person.char "I understand. When we have the chance we'll take our time and really enjoy each other."
    return
    ...
    if mc.condom:
        if the_person.wants_creampie() and the_person.get_opinion_score("creampies") > 0 and not the_person.has_taboo("condomless_sex"): #TODO: FIgure out we want any more requirements for this to fire.
            if the_person.event_triggers_dict.get("preg_knows", False):
                the_person.char "I'm already pregnant, do you want to cum inside me again?"
            elif the_person.on_birth_control:
                the_person.char "Do you want to cum inside of me? I shouldn't, but..."
                "She moans desperately."
                the_person.char "I want you to take that condom off and pump me full of your seed!"
            else:
                "She pants eagerly."
                the_person.char "Take... Take off the condom, I want you to cum inside of me!"
                the_person.char "I don't care if you get me pregnant, I need it [the_person.mc_title]!"
            ...
            the_person.char "Finish whenever you're ready [the_person.mc_title]!"
        ...
        if the_person.wants_creampie():
            if the_person.event_triggers_dict.get("preg_knows", False): #She's already knocked up, so who cares!
                ...
                if the_person.on_birth_control: #She just likes creampies.
                    the_person.char "Oh [the_person.mc_title], I want you to cum inside me! I want to feel every last drop!"
            ...
            if not the_person.on_birth_control: #You need to pull out, I'm not on the pill!
                ...
                the_person.char "We should be safe, you should pull out and finish somewhere else!"
    return
...
label reserved_cum_vagina(the_person):
    ...
    if the_person.wants_creampie():
        if the_person.event_triggers_dict.get("preg_knows", False):
            the_person.char "Oh my... There's so much of it..."
            "She closes her eyes and sighs happily."
            the_person.char "It's no mystery how you got me pregnant."
            ...
            if the_person.relationship != "Single":
                ...
                the_person.char "Oh [the_person.mc_title], look what you've done."
            else:
                the_person.char "Oh [the_person.mc_title]... I can feel your cum inside me. It's so warm."
            ...
            if the_person.relationship != "Single":
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person.char "Yes, give me all of your cum!"
            ...
            if the_person.relationship != "Single":
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person.char "Oh my... That's a lot of cum. It feels so nice."
                the_person.char "I hope my [so_title] doesn't mind if I get pregnant."

            else:
                the_person.char "Oh my... That's a lot of cum. It feels so nice."
                the_person.char "I wonder if today was a risky day? I haven't been keeping track."
        ...
        if not the_person.on_birth_control:
            ...
            the_person.char "I know you're having a good time, but I still have an [so_title]. There are boundries."

        elif the_person.get_opinion_score("creampies") < 0:
            the_person.char "[the_person.mc_title], I told you to pull out. Now look at what a mess you've made... It's everywhere."

        else:
            the_person.char "[the_person.mc_title], I told you to pull out. I guess you just lost control."
...
label reserved_creampie_taboo_break(the_person):
    if the_person.wants_creampie():
        ...
        if not the_person.on_birth_control:
            ...
            if the_person.relationship != "Single":
                $ so_title = SO_relationship_to_title(the_person.relationship)
                the_person.char "What if I get pregnant now? My [so_title] is going to start asking a lot of questions."

            else:
                the_person.char "Have you thought about what you would do if you got me pregnant?"
            ...
            $ so_title = girl_relationship_to_title(the_person.relationship)
            the_person.char "[the_person.mc_title], I told you to pull out."
            the_person.char "I'm being a already a terrible [so_title], and this just makes me feel even worse."
            the_person.char "Maybe next time you should wear a condom in case you get too excited."
