...
label wild_flirt_response_girlfriend(the_person):
    ...
    if mc.location.get_person_count() > 1:
        ...
        if the_person.effective_sluttiness("kissing") < (25 - (5*the_person.get_opinion_score("public_sex"))):
            ...
            the_person.char "Oh my god, you're such a sap. Come here."
            "She pulls you against her and kisses you intensely. She smiles when she breaks the kiss a moment later."
            the_person.char "There, that's how you should show a woman how you feel."
            mc.name "Uh huh, I think I've got the idea..."
            "You put your arms around her and kiss her back, matching her own intensity."
            the_person.char "Mmm, yeah you've got it. Don't get too excited though, we have to wait until we're alone to do anything more."
            menu:
                "Find someplace quiet.":
                    mc.name "Why wait? Come on, I'm sure we can find somewhere quiet."
                    the_person.char "That eager, huh? Alright, let's go!"
                ...
                "Just flirt.":
                    ...
                    the_person.char "Damn right it is."

        else:
            the_person.char "Well if I'm so beautiful then hurry up and kiss me, hot stuff."
            ...
            the_person.char "Why did you stop? I was having such a good time..."
            menu:
                "Make out.":
                ...
                "Just flirt.":
                    ...
                    the_person.char "Ugh, you're the worst. I was already getting turned on..."
    else:
        # You're alone, so she's open to fooling around.
        the_person.char "Well you've got me all alone, so how about you show me just how lucky you feel?"
        ...
        menu:
            ...
            "Just flirt.":
                ...
                the_person.char "Ugh, you're the worst. I was already getting so turned on..."
    return
...
label wild_flirt_response_affair(the_person):
    ...
    if mc.location.get_person_count() > 1: #There are other people around, she's nervous about people finding out what you're doing.
        if (the_person.get_opinion_score("cheating on men") *15) + the_person.effective_sluttiness() > 50: #SHe's turned on by flirting in public or doesn't think anything is wrong with it
            ...
            the_person.char "Yeah? Well... I've got some spare time, how about we slip away and you can show me what you mean."
            menu:
                "Find someplace quiet.":
                ...
                "Just flirt.":
                    ...
                    the_person.char "That's a shame. I can think of so many fun things to do with this..."
                    the_person.char "Just don't make me wait too long, okay? I barely get any action from my [so_title]."
            ...
            the_person.char "You're looking pretty hot too, but you need to be a little more subtle."
            the_person.char "I don't any rumours getting back to my [so_title]. That would really throw a wrench into our little affair..."
            ...
            the_person.char "Just be patient. I'll be all over this dick soon enough."
        ...
        the_person.char "Oh yeah? Well then, do you want to share what all of these naughty things are? You have my attention."
        menu:
            "Feel her up.":
                ...
                the_person.char "What next? What do you want to do to me?"
            ...
            "Just flirt.":
                ...
                the_person.char "Aww, are you sure?"
                "You slap her ass and step back. She clings to you reluctantly before letting go."
                the_person.char "Fine, but don't make me wait too long, okay?"
                the_person.char "I have needs, and my [so_title] sure as hell isn't fulfilling them."
    ...
    if mc.condom:
        if the_person.wants_creampie() and the_person.get_opinion_score("creampies") > 0 and not the_person.has_taboo("condomless_sex"): #TODO: FIgure out we want any more requirements for this to fire.
            if the_person.event_triggers_dict.get("preg_knows", False):
                the_person.char "Oh fuck... Take that stupid condom off and cum in my pussy!"
                the_person.char "You already knocked me up, so who fucking cares? I just fill me up!"
            elif the_person.on_birth_control:
                the_person.char "Oh fuck... I can't take it any more, take that condom off [the_person.mc_title]!"
                "She moans desperately."
                the_person.char "I give in, I want you to cum inside me!"
            else:
                the_person.char "I can't... I can't think straight!"
                "She moans desperately."
                the_person.char "Fuck it! Take the condom off and cum inside of me [the_person.mc_title]!"
                the_person.char "I want you to get me pregnant and fuck my life up!"
